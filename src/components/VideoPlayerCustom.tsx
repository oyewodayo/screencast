...
const VideoPlayerCustom: React.FC<VideoPlayerProps> = ({ src, title, autoPlay = true }) => {
  // Refs
...
const playFile = async (file: MediaFile): Promise<void> => {
  ...
  return (
    <div 
      ...
      className={`flex flex-row relative w-[100%] h-[60%] justify-start align-top place-content-start`}
    >
      {showAlert && (
        <Alert
          title={alertTitle}
