...
const EnhancedScreenOptions = ({
    ...
    const renderMainOptions = () => (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6">
            ...
            >
                <IoScanOutline className="text-5xl text-gray-700" />
                <span className="text-sm font-medium">Full Screen</span>
            </button>

            <button
                onClick={() => setMode('monitors')}
                className="flex flex-col items-center gap-2 p-4 rounded-lg border-2 border-gray-200 hover:border-green-400 hover:bg-green-50 transition-all"
            >
                <FiMonitor className="text-5xl text-gray-700" />
            ...
            <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg border-2 border-gray-200 hover:border-green-400 hover:bg-green-50 transition-all"
            >
                <IoApps className="text-5xl text-gray-700" />
                <span className="text-sm font-medium">Window</span>
            </button>

            <button
                className="flex flex-col items-center gap-2 p-4 rounded-lg border-2 border-gray-200 opacity-50 cursor-not-allowed"
                disabled
            >
                <IoDesktop className="text-5xl text-gray-700" />
            ...
            <div className="relative bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col m-4">
                ...
                <div className="flex items-center justify-between p-4 border-t">
                    ...
                    <button
                        ...
                        className="bg-black text-white px-6 py-2 rounded hover:bg-gray-800 text-sm font-medium"
                    >
                        Start Recording
                    </button>
                </div>
